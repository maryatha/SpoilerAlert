...
<head>
	<title>Top Rated Vegetarian Recipes</title>
	<h1>Top Rated Vegetarian Recipes</h1>
	<h3>Enjoy delicious vegetarian foods! Here are our users' top picks!</h3>
</head>
...
<body>
	...
	$result = $recipeHelper->getTopVegetarianRecipes();
